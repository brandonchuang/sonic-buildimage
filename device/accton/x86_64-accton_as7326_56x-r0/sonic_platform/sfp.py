...
qsfp_compliance_code_tup = ('10/40G Ethernet Compliance Code',
...
sfp_compliance_code_tup = ('10GEthernetComplianceCode',
                           'InfinibandComplianceCode', 'ESCONComplianceCodes',
                           'SONETComplianceCodes', 'EthernetComplianceCodes',
                           'FibreChannelLinkLength', 'FibreChannelTechnology',
                           'SFP+CableTechnology',
...
class Sfp(SfpBase):
    ...
    def get_transceiver_info(self):
        ...
        if self.port_num <= 48:
            ...
            sfp_interface_bulk_raw = self.__read_eeprom_specific_bytes(
                ...
                XCVR_INTFACE_BULK_WIDTH_SFP)
        else:
            offset = QSFP_INFO_OFFSET
            sfp_interface_bulk_raw = self.__read_eeprom_specific_bytes(
                (offset + XCVR_INTFACE_BULK_OFFSET),
                XCVR_INTFACE_BULK_WIDTH_QSFP)
    ...
    def get_transceiver_bulk_status(self):
        ...
        if self.port_num <= 48:  #SFP case
            ...
            transceiver_dom_info_dict = dict.fromkeys(self.dom_dict_keys,
                                                      'N/A')
            ...
            if dom_temperature_raw is not None:
                ...
                transceiver_dom_info_dict[
                    'temperature'] = dom_temperature_data['data'][
                        'Temperature']['value']
            ...
            if dom_voltage_raw is not None:
                ...
                transceiver_dom_info_dict['voltage'] = dom_voltage_data[
                    'data']['Vcc']['value']
            ...
            if dom_channel_monitor_raw is not None:
                ...
                transceiver_dom_info_dict['tx1power'] = dom_voltage_data[
                    'data']['TXPower']['value']
                transceiver_dom_info_dict['rx1power'] = dom_voltage_data[
                    'data']['RXPower']['value']
                transceiver_dom_info_dict['tx1bias'] = dom_voltage_data[
                    'data']['TXBias']['value']
            ...
            if (qsfp_dom_rev[0:8] != 'SFF-8636'
                ...
                if dom_channel_monitor_raw is not None:
                    dom_channel_monitor_data = sfpd_obj.parse_channel_monitor_params_with_tx_power(
                        dom_channel_monitor_raw, 0)
                    transceiver_dom_info_dict[
                        'tx1power'] = dom_channel_monitor_data['data'][
                            'TX1Power']['value']
                    transceiver_dom_info_dict[
                        'tx2power'] = dom_channel_monitor_data['data'][
                            'TX2Power']['value']
                    transceiver_dom_info_dict[
                        'tx3power'] = dom_channel_monitor_data['data'][
                            'TX3Power']['value']
                    transceiver_dom_info_dict[
                        'tx4power'] = dom_channel_monitor_data['data'][
                            'TX4Power']['value']

            if dom_channel_monitor_raw:
                transceiver_dom_info_dict[
                    'rx1power'] = dom_channel_monitor_data['data']['RX1Power'][
                        'value']
                transceiver_dom_info_dict[
                    'rx2power'] = dom_channel_monitor_data['data']['RX2Power'][
                        'value']
                transceiver_dom_info_dict[
                    'rx3power'] = dom_channel_monitor_data['data']['RX3Power'][
                        'value']
                transceiver_dom_info_dict[
                    'rx4power'] = dom_channel_monitor_data['data']['RX4Power'][
                        'value']
                transceiver_dom_info_dict[
                    'tx1bias'] = dom_channel_monitor_data['data']['TX1Bias'][
                        'value']
                transceiver_dom_info_dict[
                    'tx2bias'] = dom_channel_monitor_data['data']['TX2Bias'][
                        'value']
                transceiver_dom_info_dict[
                    'tx3bias'] = dom_channel_monitor_data['data']['TX3Bias'][
                        'value']
                transceiver_dom_info_dict[
                    'tx4bias'] = dom_channel_monitor_data['data']['TX4Bias'][
                        'value']
        #End of else
    ...
    def get_transceiver_threshold_info(self):
        ...
        if self.port_num <= 48:
            ...
            ) if self.get_presence() and sfpd_obj else None
    ...
    def get_tx_bias(self):
        ...
        return [tx1_bs, tx2_bs, tx3_bs,
                tx4_bs] if transceiver_dom_info_dict else []
    ...
    def get_rx_power(self):
        ...
        return [rx1_pw, rx2_pw, rx3_pw,
                rx4_pw] if transceiver_dom_info_dict else []
